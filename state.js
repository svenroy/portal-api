export const stDemoAnswers = {
  ...
  "A140": "Rebecca Jane Dagg",
  "A127": "Grey Tower Medieval Banquets",
  "A121": new Date("1999-12-12T00:00:00.000"),
  "A123": {
    "line1": "6 Canada Square",
    "line2": "E15 5GL",
    "country": "United Kingdom"
  },
  "sic_code": {
    "demo_1": {
      "A245": "[56210] Event catering activities",
      "A246": 100
    }
  },
  "A248": "No",
  "A204": "United Kingdom",
  "A240": ["Debit card", "Credit Card", "Cheques", "Bank Transfer"],
  "A232": 550000,
  "A203": "Cash flow generated directly from the company operations",
  "A215": "Provision of catering during an interactive theatrical production",
  "key_principals": {
    "demo_1": {
      "A102": "Miss",
      "A104": "Rebecca",
      ...
      "A106": "Dagg",
      "A110": {
        "line1": "15 Streatham Lane",
        "line2": "SW16 9AZ",
        "country": "United Kingdom"
      },
      "A108": new Date("1972-08-20T00:00:00.000"),
      "A111": ["United Kingdom"],
      "A239": ["Sole trader - individual"]
    }
  },
  "required_documents": {
    "Customer - Grey Tower Medieval Banquets": {
      "Utility bill": "Please upload"
    },
    "Key principal - Rebecca Jane Dagg": {
      "": "On file"
    }
  }
}

export const ucDemoAnswers = {
  _user: {
    activeGroup: "Business details"
  },
  _entity: {
  ...
  "A140": "Get Away Travels LTD",
  "A127": "Get Away Travels",
  "A133": "7264153",
  "A116": "34353223",
  "A123": {
    "line1": "19 Curtain Road",
    "line2": "E12 4AE",
    "country": "United Kingdom"
  },
  "A121": new Date("2009-05-18T00:00:00.000"),
  "A256": {
    "line1": "19 Curtain Road",
    "line2": "E12 4AE",
    "country": "United Kingdom"
  ...
  "sic_code": {
    "demo_1": {
      "A245": "[79110] Travel agency activities",
      "A246": 100
    }
  },
  "A232": 3000000,
  "A203": "Cash flow generated directly from the company operations",
  "A215": "Sale of travel packages.  Commission over money exchange",
  "related_transactions": {
    "demo_1": {
      "A214": "Cash transactions",
      "A213": "Yearly",
      "A205": 1000000,
      "A217": "Customers booking holidays and travel packages. Customers changing money within the shop."
    },
    "demo_2": {
      "A214": "International payments",
      "A207": [
        "Italy",
        "Greece",
        "Cyprus",
      ...
      "A241": 750000,
      "A206": "Yearly",
      "A218": "Payment of hotels with which agency deals have been set up.  Payment to airlines for air travel for customers",
      "A243": "Payment of employees salaries. Payment into employees pension. Payment of utilities. Payment of rent. Payment for marketing services",
    },
  },
  "key_principals": {
    "demo_1": {
      ...
      "A106": "Lambeth",
      "A110": {
        "line1": "105 Nevill Road",
        "line2": "London",
        "line3": "N16 0SU",
        "country": "United Kingdom"
      },
      "A108": new Date("1990-04-27T00:00:00.000"),
      "A111": ["United Kingdom"],
      "A255": ["Beneficial owner"]
    },
    "demo_3": {
      "A125": "Individual",
      "A102": "Mr",
      ...
      "A106": "Gilbert",
      "A110": {
        "line1": "223A Grove End Lane",
        "line2": "NW10 7QA",
        "country": "United Kingdom"
      },
      "A108": new Date("1965-06-23T00:00:00.000"),
      "A111": ["United Kingdom"],
      "A255": ["Significant controller"]
    }
  },
  "required_documents": {
    "Customer - Get Away Travels LTD": {
      "": "On file"
    },
    "Key principal - James Lambeth": {
      "": "On file",
    },
    "Key principal - Huw Gilbert": {
      "": "On file"
    },
    "Key principal - Anum Iqbal": {
      "Passport": "Please upload",
      "Proof of address": "Please upload"
    }
  }
}
...
export const demoState = {
  css: {
    ...
    RBS: `
  .topBanner {
    background: linear-gradient(to right, #0b386e, #0c4284);
  }
  ...
  .footer {
    border-top: solid 2px #0a2f64;
  }
  
  .proceedButtons .button, .file .button, .file .button:hover {
    background: #2b95d8;
  }
  
  .proceedButtons>*:first-child {
    background: #eeede9;
    color: #000;
  }
  
  .proceedButtons .button:active, .file .button:active {
    background: #0a2f64;
    color: #fff;
  }
  
  .rw-cell.rw-state-selected, .rw-list-option.rw-state-selected {
    background: #0a2f64;
    border-color: #0a2f64;
  }
  
  .rw-calendar-row>.rw-state-focus, .rw-list>.rw-state-focus  {
    border-color: #0a2f64;
  }
  
  .rw-cell.rw-state-selected:hover, .rw-list-option.rw-state-selected:hover  {
    background: #2b95d8;
    border-color: #2b95d8;
  }
